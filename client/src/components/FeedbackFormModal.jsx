...
import { submitFeedback } from '../api/events';
...
const FeedbackFormModal = () => {
  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center py-10 px-4 sm:px-6">
      ...
      {/* Modal Content */}
      <div className="relative w-full max-w-lg bg-slate-900 border border-sky-500/30 rounded-2xl shadow-2xl flex flex-col max-h-full">
        
        {/* Header */}
        <div className="bg-slate-800/80 px-6 py-4 flex justify-between items-center border-b border-white/5 shrink-0 rounded-t-2xl">
